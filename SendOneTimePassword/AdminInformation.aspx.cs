...
public partial class AdminInformation : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OleDbDataAdapter oleDbAdapter = new OleDbDataAdapter("Select * From TBLADMIN", oleDbConn);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox6.Text.Trim().Length == 0 || TextBox6.Text == "Избриши Според ID")
        {
        ...
        else
        {
            ...
            OleDbCommand oleDbCommand = new OleDbCommand("delete from TBLADMIN where ID=?", oledbConn);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            OleDbCommand olDbComm = new OleDbCommand("SELECT *FROM TBLADMIN where ID=@ID", oleDbConn);
            ...
            {
                Panel1.Visible = true;
                TextBox2.Text = oleDbReader["user_name"].ToString();
                TextBox3.Text = oleDbReader["pass_word"].ToString();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            OleDbCommand oleDbCommand = new OleDbCommand("UPDATE TBLADMIN SET user_name='" + TextBox2.Text +  "',pass_word='" + TextBox3.Text + "' where ID= @ID", oleDbConn);
            oleDbCommand.Parameters.Add("ID", OleDbType.Integer).Value = id;
            int status = oleDbCommand.ExecuteNonQuery();
